namespace NanoMessageBus.RabbitMQ
{
	...
	public partial class RabbitConnector1 : IDisposable
	{
		...
		public RabbitConnector1(object connection, RabbitTransactionType transactionType)
			: this(connection as IConnection)
		{
			this.UnitOfWork = new RabbitUnitOfWork(this.channel, null, transactionType);
		}
		public RabbitConnector1(object connection, RabbitTransactionType transactionType, RabbitAddress address)
			: this(connection as IConnection)
		{
			if (address == null)
				throw new ArgumentNullException("address");
		...
		private RabbitConnector1(IConnection connection)
		{
			if (connection == null)
