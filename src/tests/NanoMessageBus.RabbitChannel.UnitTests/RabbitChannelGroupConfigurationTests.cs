...
namespace NanoMessageBus.RabbitChannel
{
	...
	[Subject(typeof(RabbitChannelGroupConfiguration))]
	public class when_specifying_the_min_and_max_workers_values
	{
		Establish context;
		Because of;
	...
	[Subject(typeof(RabbitChannelGroupConfiguration))]
	public class when_no_min_or_max_workers_values_are_specified
	{
		Establish context;
		Because of;
	...
	[Subject(typeof(RabbitChannelGroupConfiguration))]
	public class when_specifying_a_higher_min_threads_than_the_current_max_workers_count
	{
		Establish context;
		Because of;
		It should_contain_the_min_value_specified;
